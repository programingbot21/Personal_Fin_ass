...
//             <Link href="/logout" className="block text-gray-300 hover:text-white px-3 py-2 rounded-md text-base font-medium">
//               Logout
//             </Link>
//           </div>
//           {/* Mobile Menu Button */}
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex space-x-4">
            ...
            <Link href="/dashboard" className="text-white hover:text-gray-300 px-3 py-2 rounded-md text-sm font-medium">
              Dashboard
            </Link>
          ...
          <div className="flex items-center">
            {!isAuthenticated ? (
              <>
                <Link href="/register" className="text-gray-300 hover:text-white px-3 py-2 rounded-md text-base font-medium">
                  Register
                </Link>
                <Link href="/login" className="text-gray-300 hover:text-white px-3 py-2 rounded-md text-base font-medium">
                  Login
                </Link>
              </>
            ) : (
              <button onClick={handleLogout} className="text-gray-300 hover:text-white px-3 py-2 rounded-md text-base font-medium">
                Logout
              </button>
            )}
          </div>
      ...
      {isOpen && (
        <div className="md:hidden px-2 pt-2 pb-3 space-y-1">
          ...
          {!isAuthenticated ? (
            ...
            <button onClick={handleLogout} className="block text-red-900 hover:text-white px-3 py-2 rounded-md text-base font-medium">
              Logout
            </button>
          )}
        </div>
